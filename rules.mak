...
%.ll: %.c
	$(call quiet-command,$(CLANG) -DHELPER -Wno-unknown-warning-option -S -emit-llvm $(QEMU_INCLUDES) $(QEMU_CFLAGS) $(CFLAGS) $($@-cflags) -g -Wno-unused-function -Wno-unused-variable -Wno-unused-label -O0 -c -o $@ $<,"  CC.LL $(TARGET_DIR)$@")
%.o: %.c
