...
/*
 * TODO: This function has been adapted from `tcg_dump_ops` in `tcg/tcg.c`.
 *       This print function doesnt handle:
 *       - plugins
 *       - lifetime
 *       - output preferences
 *       This functions is quite shit. It has inherited a distinct C-89 vibe
                                       ...
                                       size_t size)
{
    ...
    if (c == LIBTCG_op_insn_start) {
        ...
        fmt_append_to_stringbuffer(&buffer, " %s ", insn_name);
        /* TODO: We do not print vector arguments, this is how qemu prints them
